...
# example provincial monthly cases & deaths rtf download url http://www.boe.moph.go.th/boedb/surdata/y63/mcd_Cholera_63.rtf
...
for disease in diseases:
    for year in years:
        URL = 'http://www.boe.moph.go.th/boedb/surdata/y' + year + '/mcd_' + disease + '_' + year + '.rtf'
        headers = { 
